...
# Define file paths
Pain_Diary_Data_test = 'Test_shuffled/Pain_Diary_Data_Test_Shuffled.xlsx'

# Read in data
PD_chewAM_df = pd.read_excel(Pain_Diary_Data_test, sheet_name='Pain_Chew_AM')
PD_chewPM_df = pd.read_excel(Pain_Diary_Data_test, sheet_name='Pain_Chew_PM')
PD_yawnAM_df = pd.read_excel(Pain_Diary_Data_test, sheet_name='Pain_Yawn_AM')
PD_yawnPM_df = pd.read_excel(Pain_Diary_Data_test, sheet_name='Pain_Yawn_PM')

# load dropped ID
ID_dropped_df = pd.read_csv('Test_unshuffled/ID_dropped_df.csv')
# Drop subjects who dropped out
to_drop = ID_dropped_df.ID_shuffled_dropped.to_list()
...
df_chew_filled.to_csv('Test_shuffled/df_chew_filled_test.csv')
df_yawn_filled.to_csv('Test_shuffled/df_yawn_filled_test.csv')